...
class huobiswap(Exchange):

    def describe(self):
        return self.deep_extend(super(huobiswap, self).describe(), {
            'id': 'huobiswap',
            'name': 'Huobi Swap',
            'countries': ['CN'],
            'rateLimit': 2000,
            ...
            'accounts': None,
            'accountsById': None,
            'hostname': 'api.hbdm.com',  # api.testnet.hbdm.com
            'pro': True,
            'has': {
                'CORS': False,
                'fetchTickers': True,
            ...
            'urls': {
                'test': {
                    'market': 'https://api.testnet.hbdm.com',
                    'public': 'https://api.testnet.hbdm.com',
                    'private': 'https://api.testnet.hbdm.com',
                },
                ...
                'fees': 'https://www.huobi.com/en-us/about/fee/',
            },
            'api': {
                'market': {
                    'get': [
    ...
    async def fetch_markets(self, params={}):
        response = await self.publicGetSwapIndex(params)
        result = []
